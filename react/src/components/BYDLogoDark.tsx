...
/**
 * BYDLogoDark icon component
 */
const BYDLogoDark = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
  return (
...
BYDLogoDark.displayName = 'BYDLogoDark';

export default BYDLogoDark;
...
/**
 * BYDIconDark icon component
 */
const BYDIconDark = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
  return (
...
BYDIconDark.displayName = 'BYDIconDark';

export default BYDIconDark;
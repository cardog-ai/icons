...
export interface InfinitiIconDarkProps extends React.SVGProps<SVGSVGElement> {
 ...
 */
const InfinitiIconDark = forwardRef<SVGSVGElement, InfinitiIconDarkProps>(({ size, ...props }, ref) => {

...
export interface ChevroletIconProps extends React.SVGProps<SVGSVGElement> {
 ...
 */
const ChevroletIcon = forwardRef<SVGSVGElement, ChevroletIconProps>(({ size, ...props }, ref) => {

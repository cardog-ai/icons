...
export interface LucidLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * LucidLogoDark icon component for React Native
 */
const LucidLogoDark = ({ size, width, height, ...props }: LucidLogoDarkProps) => {

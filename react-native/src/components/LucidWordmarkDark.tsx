...
export interface LucidWordmarkDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * LucidWordmarkDark icon component for React Native
 */
const LucidWordmarkDark = ({ size, width, height, ...props }: LucidWordmarkDarkProps) => {

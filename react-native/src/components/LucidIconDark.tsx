...
export interface LucidIconDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * LucidIconDark icon component for React Native
 */
const LucidIconDark = ({ size, width, height, ...props }: LucidIconDarkProps) => {

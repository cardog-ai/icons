...
export interface BYDLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * BYDLogoDark icon component for React Native
 */
const BYDLogoDark = ({ size, width, height, ...props }: BYDLogoDarkProps) => {

...
export interface FiatWordmarkDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * FiatWordmarkDark icon component for React Native
 */
const FiatWordmarkDark = ({ size, width, height, ...props }: FiatWordmarkDarkProps) => {

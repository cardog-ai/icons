...
export interface GMCLogoHorizontalProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * GMCLogoHorizontal icon component for React Native
 */
const GMCLogoHorizontal = ({ size, width, height, ...props }: GMCLogoHorizontalProps) => {

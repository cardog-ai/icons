...
export interface FiatLogoHorizontalDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * FiatLogoHorizontalDark icon component for React Native
 */
const FiatLogoHorizontalDark = ({ size, width, height, ...props }: FiatLogoHorizontalDarkProps) => {

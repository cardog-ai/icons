...
export interface KiaIconProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * KiaIcon icon component for React Native
 */
const KiaIcon = ({ size, width, height, ...props }: KiaIconProps) => {

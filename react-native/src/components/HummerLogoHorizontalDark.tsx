...
export interface HummerLogoHorizontalDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * HummerLogoHorizontalDark icon component for React Native
 */
const HummerLogoHorizontalDark = ({ size, width, height, ...props }: HummerLogoHorizontalDarkProps) => {

...
export interface KiaWordmarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * KiaWordmark icon component for React Native
 */
const KiaWordmark = ({ size, width, height, ...props }: KiaWordmarkProps) => {
...
KiaWordmark.displayName = 'KiaWordmark';

export default KiaWordmark;
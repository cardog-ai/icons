...
export interface BYDIconDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * BYDIconDark icon component for React Native
 */
const BYDIconDark = ({ size, width, height, ...props }: BYDIconDarkProps) => {

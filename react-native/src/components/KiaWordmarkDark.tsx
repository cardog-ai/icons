...
export interface KiaWordmarkDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * KiaWordmarkDark icon component for React Native
 */
const KiaWordmarkDark = ({ size, width, height, ...props }: KiaWordmarkDarkProps) => {
...
KiaWordmarkDark.displayName = 'KiaWordmarkDark';

export default KiaWordmarkDark;
...
export interface KiaLogoHorizontalDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * KiaLogoHorizontalDark icon component for React Native
 */
const KiaLogoHorizontalDark = ({ size, width, height, ...props }: KiaLogoHorizontalDarkProps) => {

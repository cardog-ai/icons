...
export interface MiniIconDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * MiniIconDark icon component for React Native
 */
const MiniIconDark = ({ size, width, height, ...props }: MiniIconDarkProps) => {

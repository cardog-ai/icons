...
export interface GMCLogoHorizontalDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * GMCLogoHorizontalDark icon component for React Native
 */
const GMCLogoHorizontalDark = ({ size, width, height, ...props }: GMCLogoHorizontalDarkProps) => {

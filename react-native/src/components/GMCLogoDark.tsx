...
export interface GMCLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * GMCLogoDark icon component for React Native
 */
const GMCLogoDark = ({ size, width, height, ...props }: GMCLogoDarkProps) => {

...
export interface LucidLogoHorizontalDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * LucidLogoHorizontalDark icon component for React Native
 */
const LucidLogoHorizontalDark = ({ size, width, height, ...props }: LucidLogoHorizontalDarkProps) => {

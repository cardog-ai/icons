...
export interface KiaLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * KiaLogoDark icon component for React Native
 */
const KiaLogoDark = ({ size, width, height, ...props }: KiaLogoDarkProps) => {
...
KiaLogoDark.displayName = 'KiaLogoDark';

export default KiaLogoDark;
...
export interface HummerLogoProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * HummerLogo icon component for React Native
 */
const HummerLogo = ({ size, width, height, ...props }: HummerLogoProps) => {
...
HummerLogo.displayName = 'HummerLogo';

export default HummerLogo;
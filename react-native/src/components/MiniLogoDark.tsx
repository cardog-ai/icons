...
export interface MiniLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * MiniLogoDark icon component for React Native
 */
const MiniLogoDark = ({ size, width, height, ...props }: MiniLogoDarkProps) => {
...
MiniLogoDark.displayName = 'MiniLogoDark';

export default MiniLogoDark;
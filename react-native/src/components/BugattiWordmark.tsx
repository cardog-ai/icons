...
export interface BugattiWordmarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * BugattiWordmark icon component for React Native
 */
const BugattiWordmark = ({ size, width, height, ...props }: BugattiWordmarkProps) => {

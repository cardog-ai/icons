...
export interface HummerWordmarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * HummerWordmark icon component for React Native
 */
const HummerWordmark = ({ size, width, height, ...props }: HummerWordmarkProps) => {

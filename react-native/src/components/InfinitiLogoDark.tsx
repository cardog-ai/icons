...
export interface InfinitiLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * InfinitiLogoDark icon component for React Native
 */
const InfinitiLogoDark = ({ size, width, height, ...props }: InfinitiLogoDarkProps) => {

...
export interface GMCWordmarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * GMCWordmark icon component for React Native
 */
const GMCWordmark = ({ size, width, height, ...props }: GMCWordmarkProps) => {

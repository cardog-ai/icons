...
export interface KiaIconDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * KiaIconDark icon component for React Native
 */
const KiaIconDark = ({ size, width, height, ...props }: KiaIconDarkProps) => {
...
KiaIconDark.displayName = 'KiaIconDark';

export default KiaIconDark;
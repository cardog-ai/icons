...
export interface HummerLogoHorizontalProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * HummerLogoHorizontal icon component for React Native
 */
const HummerLogoHorizontal = ({ size, width, height, ...props }: HummerLogoHorizontalProps) => {

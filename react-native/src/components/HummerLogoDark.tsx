...
export interface HummerLogoDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * HummerLogoDark icon component for React Native
 */
const HummerLogoDark = ({ size, width, height, ...props }: HummerLogoDarkProps) => {

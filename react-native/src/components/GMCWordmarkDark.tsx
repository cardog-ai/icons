...
export interface GMCWordmarkDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * GMCWordmarkDark icon component for React Native
 */
const GMCWordmarkDark = ({ size, width, height, ...props }: GMCWordmarkDarkProps) => {

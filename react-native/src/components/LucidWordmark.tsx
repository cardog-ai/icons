...
export interface LucidWordmarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * LucidWordmark icon component for React Native
 */
const LucidWordmark = ({ size, width, height, ...props }: LucidWordmarkProps) => {

...
export interface JeepLogoProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * JeepLogo icon component for React Native
 */
const JeepLogo = ({ size, width, height, ...props }: JeepLogoProps) => {
...
JeepLogo.displayName = 'JeepLogo';

export default JeepLogo;
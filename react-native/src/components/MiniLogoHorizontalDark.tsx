...
export interface MiniLogoHorizontalDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * MiniLogoHorizontalDark icon component for React Native
 */
const MiniLogoHorizontalDark = ({ size, width, height, ...props }: MiniLogoHorizontalDarkProps) => {

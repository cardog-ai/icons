...
export interface InfinitiWordmarkDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * InfinitiWordmarkDark icon component for React Native
 */
const InfinitiWordmarkDark = ({ size, width, height, ...props }: InfinitiWordmarkDarkProps) => {

...
export interface HummerWordmarkDarkProps extends SvgProps {
  /** Size of the icon (sets both width and height) */
  size?: number;
}

/**
 * HummerWordmarkDark icon component for React Native
 */
const HummerWordmarkDark = ({ size, width, height, ...props }: HummerWordmarkDarkProps) => {
